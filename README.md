# 온라인 강의 통합 서비스 (MoMent) Django

## 프로젝트 소개
1. 프로젝트 개요

MoMent는 다양한 온라인 강의 플랫폼에 분산된 교육 콘텐츠를 한 곳에 모아,
사용자가 더 빠르고 효율적으로 원하는 강의를 찾을 수 있도록 돕는 통합 강의 탐색 플랫폼입니다.

온라인 강의 시장이 확장됨에 따라 Udemy, Coursera, Inflearn 등 여러 플랫폼에 강의가 분산되어
탐색 비용이 증가하고, 가격 변동 또한 확인하기 어려운 문제가 존재합니다.

MoMent는 이러한 문제를 해결하기 위해
통합 검색, 가격 히스토리 추적, 개인화 추천 기능을 제공하여
사용자가 가장 합리적인 선택을 할 수 있도록 지원합니다.
<br/>
